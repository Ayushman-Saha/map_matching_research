...
In the synthetic dataset utilized for this study, each trajectory is characterized by a diverse set of attributes that encapsulate various aspects of its features. These attributes include osmid, X, Y, maxspeed, turn\_severity\_index, turn\_density, significant\_turns, traffic, geometry, betweenness\_centrality, length, reversed, avg\_cloud\_cover, avg\_rainfall, and avg\_visibility. Collectively, these attributes provide a comprehensive representation of the trajectories, integrating spatial, geometric, and environmental factors to facilitate detailed analysis and insights.


\begin{table}[H]
\centering
\caption{Attributes and Their Data Types in the Dataset}
  \begin{tabular}{|c|c|}
    \hline
    ...
    X & string \\ \hline
    Y & string \\ \hline
    maxspeed & string \\ \hline
    turn\_severity\_index & string \\ \hline
    turn\_density & string \\ \hline
    significant\_turns & string \\ \hline
    traffic & string \\ \hline
    geometry & string \\ \hline
    betweenness\_centrality & string \\ \hline
    length & string \\ \hline
    reversed & string \\ \hline
    avg\_cloud\_cover & string \\ \hline
    avg\_rainfall & string \\ \hline
    avg\_visibility & string \\ \hline
  \end{tabular}
  \end{table}
